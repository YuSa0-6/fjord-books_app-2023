...
class Report < ApplicationRecord
  ...
  has_many :mentioning_mentions, class_name: 'Mention', foreign_key: :mentioning_report_id, dependent: :destroy # rubocop:disable Rails/InverseOf
  has_many :mentioned_reports, through: :mentioning_mentions, source: :mentioned_report

  has_many :mentioned_mentions, class_name: 'Mention', foreign_key: :mentioned_report_id, dependent: :destroy # rubocop:disable Rails/InverseOf
